...
const ProductDetail = () => {
  ...
  <div className="mb-8"> <h2 className="text-xl font-bold mb-4 text-foreground">Product Description :</h2> <p className="text-4xl font-bold mb-4" leading-relaxed">{product.description || 'No description available.'}</p> 
 </div>
